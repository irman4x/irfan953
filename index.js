const  XBOT = 'IRMAN'; // Nama Bot Whatsapp
const instagram = 'https://instagram.com/irfan_mln09.05'; // Nama Instagramlu cok
const nomer = 'https://Wa.me/+6289673456025'; // Nomor whatsapplu cok
const aktif = 'Tergantung kuota makanya donasi'; // Kapan bot lu aktif
...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            + 'VERSION:3.0\n' 
            + 'FN:affis\n' // full name
            + 'ORG:Owner  XBOT IRMAN;\n' // the organization of the contact
            + 'TEL;type=CELL;type=VOICE;waid=6289673456025:+62 896-7345-6025\n' // WhatsApp ID + phone number
            + 'END:VCARD'
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @irfan_mln09.05`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @irfan_mln09.05`)
})
